...
public class RedCenterPegTwoGearAuto extends CommandGroup {
	...
	addSequential(new DriveDistancePID(DriveConstants.RedWallToCenterPegDistance, DriveConstants.RedWallToCenterPegDistance));
	// addSequential(new DeployGear());
	addSequential(new DriveDistancePID(DriveConstants.RedCenterPegBackUpDistance, DriveConstants.RedCenterPegBackUpDistance));

	addSequential(new WaitTime(0.3));
	addSequential(new TurnToAngle(DriveConstants.RedWallToSecondGearAngle, 4, true));
	addSequential(new WaitTime(0.3));
	addSequential(
		new DriveDistancePID(DriveConstants.RedWallToSecondGearDistance, DriveConstants.RedWallToSecondGearDistance));
	...
	addSequential(
		new DriveDistancePID(-DriveConstants.RedCenterPegBackUpDistance, -DriveConstants.RedCenterPegBackUpDistance));
	// addSequential(new DeployGear());
